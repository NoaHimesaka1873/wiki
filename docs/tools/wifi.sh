...
case "$os" in
  Darwin)
    ...
    for ISLAND in hawaii; do
      ...
      for ((LINE = 1; LINE <= "$NVRAM_NUMBER"; ++LINE)); do
    ...
    for ISLAND in ekans hanauma kahana kauai lanai maui midway nihau sid; do
    ...
    for ISLAND in bali borneo hanauma kahana kure sid trinidad; do
    ...
    for ISLAND in fiji formosa tahiti; do
